...
import com.skydoves.mvvm_coroutines.ui.main.MainActivityViewModel
...
class MainActivityViewModelTest {
  ...
  fun loadMovieListFromNetwork() = runBlocking {
    ...
    val data = discoverRepository.loadMovies(1) { }
  ...
  fun loadTvListFromNetwork() = runBlocking {
    ...
    val data = discoverRepository.loadTvs(1) { }
  ...
  fun loadPeopleFromNetwork() = runBlocking {
    ...
    val data = peopleRepository.loadPeople(1) { }
